                                                    ...
                                                    <div>
                                                        <div style={{ marginTop: '20px' }}>
                                                            <div className='flex justify-between items-center mb-4'>
                                                                ...
                                                                <Select
                                                                    items={sortOptions}
                                                                    onItemSelected={handleSortOptionChange}
                                                                    color={cardColor}
                                                                />
                                                            </div>
                                                            {sortedTodos
                                                                        ...
                                                                        <div>
                                                                            {editingTodo === todo ? (
                                                                                ...
                                                                                <Checkbox
                                                                                    ...
                                                                                    item={
                                                                                        <div
                                                                                            dangerouslySetInnerHTML={{ __html: linkify(todo.text) }}
                                                                                        />
                                                                                    }
                                                    ...
                                                    <div>
                                                        {!hideCompleted && (
                                                            <div style={{ marginTop: '50px' }}>
                                                                {!(
                                                                    selectedBadge === 'Today' ||
                                                                    selectedBadge === 'Overdue' ||
                                                                    selectedBadge === 'Tomorrow'
                                                                ) && <h2 className='text-2xl font-bold mb-4'>Completed Tasks</h2>}
                                                                {completedTodos.filter(isTodoVisible).map((todo) =>
                                                                    todo.completed &&
                                                                    (selectedBadge === 'Today' ||
                                                                        selectedBadge === 'Overdue' ||
                                                                        selectedBadge === 'Tomorrow') ? null : (
                                                                        <div
                                                                            key={todo.id}
                                                                            className={`flex items-start justify-between ${
                                                                                todo.completed ? 'line-through' : ''
